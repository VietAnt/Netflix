class MovieModel {
  ...
  final String name;
  final String image;
  final double qualification; //danh gia
  final int year; //nam
  final String duration; //thoi gian chieu
  final String genre; //the loai
  final String description; //mieu ta

  //--Contructor- MovieModel--//
  MovieModel(
      {required this.id,
      required this.name,
      required this.image,
  ...
  //--Danhsach MovieModel-List MovieModel--// List<MovieModel> listMovie =[]
  static List<MovieModel> listMovie = [
    MovieModel(
        id: '1',
        name: 'Venom: Let There Be Carnage',
        image: 'cinema/movie1.jpg',
        qualification: 5,
        year: 2021,
        duration: '1h 37m',
